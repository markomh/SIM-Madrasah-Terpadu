...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('rombel', function (Blueprint $table) {
            ...
            $table->foreignUuid('id_tingkat')->constrained('tingkat_pendidikan', 'id_tingkat');
        ...
        Schema::create('pemetaan_kenaikan', function (Blueprint $table) {
            ...
            $table->foreignUuid('id_tahun')->constrained('tahun_ajaran', 'id_tahun'); // Tahun ajaran tujuan
            $table->timestamps();
        });
        ...
        Schema::create('jadwal_pelajaran', function (Blueprint $table) {
            ...
            $table->foreignUuid('id_rombel')->constrained('rombel', 'id_rombel'); // Tenant diwarisi lewat rombel
